<template>
	<section>
		...
		<!--列表-->
		<el-table :data="projectFiles" size="small" highlight-current-row v-loading="listLoading" @selection-change="selsChange" style="width: 100%;" height="500" border>
			...
			<el-table-column prop="explain" label="说明" min-width="120" sortable>
			</el-table-column>
			<el-table-column prop="createTime" label="创建时间" width="140" :formatter="dateFormat" sortable>
			</el-table-column>
			<el-table-column prop="createUserName" label="创建人"  sortable>
			</el-table-column>
		...
		<el-dialog title="编辑" :visible.sync="editVisible">
		    <el-form :model="editForm" label-width="80px" :rules="editFormRules" ref="editForm">
		    	<el-form-item label="项目名" prop="projectName">
					<el-autocomplete class="inline-input" v-model="editForm.projectName" :fetch-suggestions="projectSearch"
				      placeholder="请输入项目名" @select="projectEditSelect" size="80" clearable></el-autocomplete>
				</el-form-item>
